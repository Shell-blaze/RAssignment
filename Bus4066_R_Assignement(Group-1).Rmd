...
# Function to return the no of players having market value greate than 10 million
...
## Aggregate the data
scatter_aggregated_data <- players_ds %>%
  group_by(current_club_domestic_competition_id, position) %>%
  summarise(player_count = n())

ggplot(scatter_aggregated_data, aes(x = current_club_domestic_competition_id, y = player_count, colour =   position)) +
  geom_point() +
  labs(title = "Number of Players in Each Position in each Domestic Competition",
       x = "Domestic Competition",
       y = "Number of Players",
       color = "Position")  +
